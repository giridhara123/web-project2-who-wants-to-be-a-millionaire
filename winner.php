...
<body style = "text-align:center">
	...
	<br><br>
	<img src="million.png" alt="Who Wants To Be A Millionaire Logo" width='350px' height='350px' />
	<br><br>
	<div class="gif-overlay">
		...
		<button onclick="document.location='leaderboard.php'">Go to leaderboard</button>
	</div>
</body>
